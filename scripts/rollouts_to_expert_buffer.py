...
import numpy as np
from crisp_drl.agents.rlpd.rewards import dense_place_reward, xy_dense_place_reward
...
def main():
    ...
    for file in os.listdir(os.path.join("rollouts", rollout_directory)):
        ...
        rewards = xy_dense_place_reward(actions, observations, [data["reset_info"]] + infos, max_rew=0.01, max_action_magnitude=0.0008,
