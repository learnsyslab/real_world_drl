...
exp_name = "angled_bracket_test_pe_g"
poses_file = "test_images/angle_bracket_poses.txt"
sam3_prompt = "metal grey angle bracket"
MESH_FILE_NAME = "angle_bracket_centered.obj"
