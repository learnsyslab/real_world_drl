...
class RLPDActor:
    ...
    def _create_env(self) -> ManipulatorCartesianEnv:
        ...
        #                             insert_randomization_bounds=(np.array([-0.01, -0.01, 0.0]), np.array([0.01, 0.01, 0.005])), action_sequence=load_actions_safe("v3_pick_up.json")) # load_actions_safe("v3_pick_up.json")
        ...
        # env = CartesianStateToInfoMover(env)
